...
<head>
    ...
    <meta name="description" content="Essays and observations on operational maturity, founder transitions, and what it actually takes to build a company that works without you holding it together.">
...
<div class="wrap">
    ...
    <h1>Essays &amp; observations</h1>
    <p class="page-sub">On operational maturity, founder transitions, and what it actually takes to build a company that works without you holding it together.</p>
    <div class="post-list">
{{post_items}}
    </div>
</div>
