...
Tech debt works exactly like the name says: it's borrowed, not free, and it carries an interest rate. In our conversation we landed on hiring as a better example than contracts even to point out how comparable to (tech) debt this is. A bad hire isn't a one-off cost — it's a loan, and the interest rate is brutal. Two bad hires, not five, not ten, just two, will keep you occupied almost full-time: managing around them, covering for them, eventually replacing them. 
