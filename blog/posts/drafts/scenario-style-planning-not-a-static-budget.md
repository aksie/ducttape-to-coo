...
cta_secondary_text: "Wiki: Financial Planning (2.2) →"
cta_secondary_href: "../wiki.html#2.2--first-hires"
footer: "Part of the Duct Tape to COO framework. Practitioner material (Stefan + Nalden IFTTT framing). Canonical source: wiki-pipeline/contributions/financial-2.1-2.2--scenario-planning-first-hires.md"
---
