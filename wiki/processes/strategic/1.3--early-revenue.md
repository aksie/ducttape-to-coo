...
sensitivity: "none"
conditions: []
last_updated: "2026-06-03 21:00:00 +0200"
stage_focus: "Document channel guidelines and CS→engineering escalation. Add an incident fast lane and light artifact map — spoken norms break when handoffs multiply."
---
...
3. **Document CS → engineering (and similar) handoffs explicitly** — ticket-first, channel-then-ticket, or another path you choose; the format matters less than everyone using the same one. If CS and engineering still disagree on mentions or channels, run the **joint norm session** described on [First Hires](./1.3--first-hires.md) (what to do, item 5): both leads name each complaint, agree a shared path, then **capture that agreement in your escalation table** — not only in a Slack thread.
...
*Draft — extends first-hires pipeline; early-revenue entry not yet in `wiki-pipeline/entries/`.*

- [Communication norms — synthesized research note](../../../wiki-pipeline/sources/src-047.md) · pipeline synthesis · super-atom [atom-218](../../../wiki-pipeline/atoms/atom-218.md) · [atom-211](../../../wiki-pipeline/atoms/atom-211.md) (evolution)
- [Practitioner contribution — cross-team communication friction](../../../wiki-pipeline/contributions/strategic-1.3--cross-team-communication-friction.md) · [pipeline record](../../../wiki-pipeline/sources/src-049.md)
- First-hires published page: [1.3 — First Hires](./1.3--first-hires.md) · pipeline: [`communication-norms/first-hires/`](../../../wiki-pipeline/entries/strategic-ops/communication-norms/first-hires/)
