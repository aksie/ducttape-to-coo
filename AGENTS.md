...
|---|---|
| External source (handbook, blog post, talk) | `prompts/phase-1-discovery-and-extraction.md` → `phase-2-synthesis-to-reviewable-proposals.md` → `phase-3-human-review.md` → `phase-4-publish.md` |
