...
Frames the abstract "founder gap" theory (Greiner/Turner/McKeown/PAEI, already in the related essay) in terms of three observable, portfolio-wide recurring shortfalls rather than a single crisis moment — useful as a concrete "what good looks like" companion to the existing more theory-driven claims in this entry, and as a checklist a board or advisor could actually use to spot the gap early.
