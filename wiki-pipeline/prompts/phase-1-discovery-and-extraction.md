...
- 11 sources registered (src-087–097): 3 HN threads, 6 first-person practitioner blogs, 2 VC-firm reference pieces (NFX, Forbes/Kjartan Rist)
...
- Key synthesis material: the "more control" reflex under underperformance traces to LP-pressure cascading onto investors, who pass it to founders as scrutiny (atom-652) — this directly explains the practitioner-interview seed observation; boards-as-reporting-forum vs boards-as-forward-looking-decision-support is the clearest role-clarity fault line (atom-668/669/671); "never surprise the board" and "it's still your meeting" are the strongest founder-side correctives (atom-673–675)
