...
### Shareholder Reporting @ Early Revenue (board-founder roles focus) (1.2b)
- Topic focus (not the whole cell): board and founder role clarity — what a board is actually there to do, and where that goes wrong, sourced from a practitioner-interview seed rather than a blank cell scan
- 11 sources registered (src-083–093): 3 HN threads, 6 first-person practitioner blogs, 2 VC-firm reference pieces (NFX, Forbes/Kjartan Rist)
- Vendor bias risk: low in the usual sense — **zero** sources sell a board-related product — but **investor-perspective concentration is real**: 5 of 9 "practitioner" sources are working VCs writing in first person (Jerry Neumann, David Paul, Rishi Taparia), and genuinely founder-authored accounts (TechCrunch guest piece, The Juice HQ, HN commenters) are the minority. Corpus health file recommends a disclosure disclaimer for this reason, distinct from the usual vendor-bias trigger
- No formal adversarial resweep needed (0% vendor-interest sources) — but the discovery queries were written adversarially from the start (searched directly for "boards are dangerous to founders," board resignations, VC self-critique of shaming founders), so the corpus already skews toward dissent from the "boards are simply good for you" narrative rather than needing a second pass to find it
- Key synthesis material: the "more control" reflex under underperformance traces to LP-pressure cascading onto investors, who pass it to founders as scrutiny (atom-638) — this directly explains the practitioner-interview seed observation; boards-as-reporting-forum vs boards-as-forward-looking-decision-support is the clearest role-clarity fault line (atom-654/655/657); "never surprise the board" and "it's still your meeting" are the strongest founder-side correctives (atom-659–661)
...
- Run date: 2026-09-15 — src-083–093, atoms atom-626–661
