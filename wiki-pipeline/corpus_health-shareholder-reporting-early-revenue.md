...
- Total sources registered: 11 (src-083–093)
- Practitioner-led (type `hn` or `practitioner_blog`): 9 of 11 (82%) — HN threads ×3 (src-083, 085, 086), first-person practitioner blogs ×6 (src-084, 087, 088, 089, 090, 093)
- VC firm / advisory (type `vc_firm`): 2 of 11 (18%) — src-091 (NFX), src-092 (Forbes/Kjartan Rist)
- Vendor / commercial-interest (selling a board-related product): 0 registered
- News / academic: 0 (TechCrunch guest piece src-090 is practitioner-authored, counted as practitioner_blog)

**Investor-perspective concentration within the practitioner tier:** of the 9 practitioner-tagged sources, 5 are written by working VCs in first person (src-084 Jerry Neumann, src-087 David Paul, src-088 Rishi Taparia, plus the 2 formal `vc_firm` sources). Only src-089 (operator/board member, not a fund), src-090 (ex-CEO), and src-093 (founder company blog) are unambiguously founder/operator-side, alongside the three HN threads (mixed commenters, generally founder-leaning). **This is a real skew** even though it's not "vendor bias" in the usual sense — see Disclosure status below.

## Geographic mix

- US: 8 (src-084, 087, 088, 089, 090, 091, 092, 093)
- Global/Unknown: 3 (src-083, 085, 086 — HN threads, commenter locations not identifiable)
- EU/NL: 0

## Bias flags raised

- `vc_industry_veteran`: 3 atoms (atom-628, 629, 630) — src-084, a 25-year VC writing critically about board power dynamics
- `vc_investor_self_interest`: 7 atoms (atom-636–642) — src-087, src-088, both working VCs
- `vc_portfolio_interest`: 7 atoms (atom-651–657) — src-091 (NFX), src-092 (Forbes/Rist)
