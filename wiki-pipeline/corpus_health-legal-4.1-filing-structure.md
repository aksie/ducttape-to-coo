---
entry: legal/filing-structure (processes 4.1, 2.5, 3.1)
last_updated: 2026-06-03
---

## Source mix

- Total sources: 3 (all practitioner contributions from the same contributor)
- Practitioner-led: 3 (100%)
- Vendor / commercial-interest: 0 (0%)
- Advisory firm / VC: 0 (0%)
- News / academic: 0 (0%)

## Geographic mix

- NL/EU: 3 (100%) — Dutch BV context throughout; KvK, WBSO, Arbowet, BTW references
- US: 0
- Global/Unknown: 0

## Bias flags raised

- None. All three sources are first-person practitioner contributions from an operator with buy-side and sell-side M&A experience. No commercial interest in any claim.
